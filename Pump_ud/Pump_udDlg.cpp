...
Int32 CPump_udDlg::DisDeviceStatus(Int32 obj, Int32 Status)
{
		...
		else if (obj == MDS)
		{
			switch (Status)
			{
			case ERROR_MDS_SetFreq_Buile_Fail: MessageBox(_T("ERROR_MDS_SetFreq_Buile_Fail        ")); break;//E710 MDS-编译指令错误（DSP提供内存不足）
			case ERROR_MDS_SetFreq_232_TimeOut: MessageBox(_T("ERROR_MDS_SetFreq_232_TimeOut       ")); break;//E711 MDS -232接收超时
			case ERROR_MDS_SetFreq_Ask_Buile_Fail: MessageBox(_T("ERROR_MDS_SetFreq_Ask_Buile_Fail    ")); break;//E712 MDS -接收泵回复信息编译错误
			case ERROR_MDS_SetFreq_SetValuelInvalid: MessageBox(_T("ERROR_MDS_SetFreq_SetValuelInvalid  ")); break;//E713 MDS -PC设置的值无效
			case ERROR_MDS_SetFreq_ReturnInvalid: MessageBox(_T("ERROR_MDS_SetFreq_ReturnInvalid     ")); break;//E714 MDS-返回值不在指定访问内，DSP系统故障
			case ERROR_MDS_SetPow_Buile_Fail: MessageBox(_T("ERROR_MDS_SetPow_Buile_Fail         ")); break;//E715 MDS-编译指令错误（DSP提供内存不足）
			case ERROR_MDS_SetPow_232_TimeOut: MessageBox(_T("ERROR_MDS_SetPow_232_TimeOut        ")); break;//E716 MDS -232接收超时
			case ERROR_MDS_SetPow_Ask_Buile_Fail: MessageBox(_T("ERROR_MDS_SetPow_Ask_Buile_Fail     ")); break;//E717 MDS -接收泵回复信息编译错误
			case ERROR_MDS_SetPow_SetValuelInvalid: MessageBox(_T("ERROR_MDS_SetPow_SetValuelInvalid   ")); break;//E718 MDS -PC设置的值无效
			case ERROR_MDS_SetPow_ReturnInvalid: MessageBox(_T("ERROR_MDS_SetPow_ReturnInvalid      ")); break;//E719 MDS-返回值不在指定访问内，DSP系统故障
			case ERROR_MDS_SetdBm_Buile_Fail: MessageBox(_T("ERROR_MDS_SetdBm_Buile_Fail         ")); break;//E710 MDS-编译指令错误（DSP提供内存不足）
			case ERROR_MDS_SetdBm_232_TimeOut: MessageBox(_T("ERROR_MDS_SetdBm_232_TimeOut        ")); break;//E711 MDS -232接收超时
			case ERROR_MDS_SetdBm_Ask_Buile_Fail: MessageBox(_T("ERROR_MDS_SetdBm_Ask_Buile_Fail     ")); break;//E712 MDS -接收泵回复信息编译错误
			case ERROR_MDS_SetdBm_SetValuelInvalid: MessageBox(_T("ERROR_MDS_SetdBm_SetValuelInvalid   ")); break;//E713 MDS -PC设置的值无效
			case ERROR_MDS_SetdBm_ReturnInvalid: MessageBox(_T("ERROR_MDS_SetdBm_ReturnInvalid      ")); break;//E714 MDS-返回值不在指定访问内，DSP系统故障
			case ERROR_MDS_SetSwitch_Buile_Fail: MessageBox(_T("ERROR_MDS_SetSwitch_Buile_Fail      ")); break;//E710 MDS-编译指令错误（DSP提供内存不足）
			case ERROR_MDS_SetSwitch_232_TimeOut: MessageBox(_T("ERROR_MDS_SetSwitch_232_TimeOut     ")); break;//E711 MDS -232接收超时
			case ERROR_MDS_SetSwitch_Ask_Buile_Fail: MessageBox(_T("ERROR_MDS_SetSwitch_Ask_Buile_Fail  ")); break;//E712 MDS -接收泵回复信息编译错误
			case ERROR_MDS_SetSwitch_SetValuelInvalid: MessageBox(_T("ERROR_MDS_SetSwitch_SetValuelInvalid")); break;//E713 MDS -PC设置的值无效
			case ERROR_MDS_SetSwitch_ReturnInvalid: MessageBox(_T("ERROR_MDS_SetSwitch_ReturnInvalid   ")); break;//E714 MDS-返回值不在指定访问内，DSP系统故障
			case ERROR_MDS_RepPara_Buile_Fail: MessageBox(_T("ERROR_MDS_RepPara_Buile_Fail        ")); break;//E710 MDS-编译指令错误（DSP提供内存不足）
			case ERROR_MDS_RepPara_232_TimeOut: MessageBox(_T("ERROR_MDS_RepPara_232_TimeOut       ")); break;//E711 MDS -232接收超时
			case ERROR_MDS_RepPara_Ask_Buile_Fail: MessageBox(_T("ERROR_MDS_RepPara_Ask_Buile_Fail    ")); break;//E712 MDS -接收泵回复信息编译错误
			case ERROR_MDS_RepPara_SetValuelInvalid: MessageBox(_T("ERROR_MDS_RepPara_SetValuelInvalid  ")); break;//E713 MDS -PC设置的值无效
			case ERROR_MDS_RepPara_ReturnInvalid: MessageBox(_T("ERROR_MDS_RepPara_ReturnInvalid     ")); break;//E714 MDS-返回值不在指定访问内，DSP系统故障                                           
			default:
				MessageBox(strA);
				break;
			}
